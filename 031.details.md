...
[details --no-link]:[`sudo cat /var/log/openvpn_openvpn.log`](./031/files/sudo-cat-_var_log_openvpn_openvpn-status.log.txt)

[details --no-link]:[`sudo cat /var/log/openvpn_openvpn-status.log`](./031/files/sudo-cat-_var_log_openvpn_openvpn.log.txt)
