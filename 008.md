...
По моему личному мнению исходный файл управления процессом [/etc/init.d/spawn-fcgi](./008/vm/guest/home/vagrant/host/hw_part_2/spawn-fcgi.sh) 
...
Unit-файл сервиса [/etc/systemd/vagrant/spawn-fcgi.service](./008/vm/guest/etc/systemd/vagrant/spawn-fcgi.service)
...
__Корень зла!__. Я не смог заставить работать даже родной `init.d` у `spawn-fcgi`: [/etc/init.d/spawn-fcgi](./008/vm/guest/home/vagrant/host/hw_part_2/spawn-fcgi.sh)
...
Unit-файл сервиса [/etc/systemd/vagrant/httpd-pro.service](008/vm/guest/etc/systemd/vagrant/httpd-pro@.service) 
