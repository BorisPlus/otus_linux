...
Таким образом на хосте с нужными ключами к VPN на гостевой (на практике это гостевая далеко в облаке с пробросом единственного порта) возможно подключиться либо так
...
либо так (замечание: нужно подправить автомаршруты)
...
Доступен "удаленно" исключительно из-под VPN сети:

<img src="./031/files/img/tunras5.png" width="200px">

__очень важно!!!__: Сравните как меняются маршруты при одной и той же конфигурации VPN-сервера. Суть в том, что Network Manager слишком "умный" и нормально не дает работать.
