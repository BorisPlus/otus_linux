...
[details --no-link]:[sql: SHOW SLAVE STATUS \G](./039/files/replica_before-show_slave_status.txt)

[details --no-link]:[sql: SHOW TABLES;](./039/files/replica_before-slave_show_tables.txt)

[details --no-link]:[sql: SELECT * FROM bookmaker;](./039/files/replica_before-select_from_bookmaker.txt)
...
[details --no-link]:[sql: INSERT INTO ...; SELECT * FROM bookmaker;](./039/files/master_check-select_after_insert.txt)

[details --no-link]:[sql: SHOW BINLOG EVENTS;](./039/files/master_check-show_binlog_events.txt)

[details --no-link]:[sql: SHOW MASTER STATUS;](./039/files/master_check-show_master_status.txt)
...
[details --no-link]:[sql: SHOW SLAVE STATUS \G](./039/files/replica_after-show_slave_status.txt)

[details --no-link]:[sql: SHOW TABLES;](./039/files/replica_after-slave_show_tables.txt)

[details --no-link]:[sql: SELECT * FROM bookmaker;](./039/files/replica_after-select_from_bookmaker.txt)
