...
Таким образом [скрипт](002/v1/make_raid5.sh) по созданию RAID5 и [файл настройки](./002/v1/mdadm.conf) автосборки RAID5 при загрузке.
...
Перенос системы на RAID1 сделаю позже. 