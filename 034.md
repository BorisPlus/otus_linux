...
[лог `playbooks/server.yml`](./034/files/server.yml.txt)
...
[процесс автоматизированного посредством Ansible конфигурирования IPA](./034/files/ipa_server_configure_log.txt)
