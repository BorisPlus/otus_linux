...
fatal: [replica]: FAILED! => {"changed": true, "cmd": "pg_basebackup -X stream -h 192.168.40.10 -D /var/lib/pgsql/11/data/ -P -U replicator -W", "delta": "0:00:00.254287", "end": "2021-10-18 01:09:15.142713", "msg": "non-zero return code", "rc": 1, "start": "2021-10-18 01:09:14.888426", "stdout": "Пароль: \r\npg_basebackup: FATAL:  password authentication failed for user \"replicator\"", "stdout_lines": ["Пароль: ", "pg_basebackup: FATAL:  password authentication failed for user \"replicator\""]}
...
failed: [replica] (item=SELECT datname AS database_name FROM pg_database;) => {"ansible_loop_var": "item", "changed": true, "cmd": "sudo -iu postgres psql -c \"SELECT datname AS database_name FROM pg_database;\"", "delta": "0:00:00.137776", "end": "2021-10-18 01:09:19.166215", "item": "SELECT datname AS database_name FROM pg_database;", "msg": "non-zero return code", "rc": 2, "start": "2021-10-18 01:09:19.028439", "stderr": "psql: не удалось подключиться к серверу: Нет такого файла или каталога\n\tОн действительно работает локально и принимает\n\tсоединения через Unix-сокет \"/var/run/postgresql/.s.PGSQL.5432\"?", "stderr_lines": ["psql: не удалось подключиться к серверу: Нет такого файла или каталога", "\tОн действительно работает локально и принимает", "\tсоединения через Unix-сокет \"/var/run/postgresql/.s.PGSQL.5432\"?"], "stdout": "", "stdout_lines": []}
failed: [replica] (item=SELECT schema_name FROM information_schema.schemata;) => {"ansible_loop_var": "item", "changed": true, "cmd": "sudo -iu postgres psql -c \"SELECT schema_name FROM information_schema.schemata;\"", "delta": "0:00:00.126855", "end": "2021-10-18 01:09:19.838143", "item": "SELECT schema_name FROM information_schema.schemata;", "msg": "non-zero return code", "rc": 2, "start": "2021-10-18 01:09:19.711288", "stderr": "psql: не удалось подключиться к серверу: Нет такого файла или каталога\n\tОн действительно работает локально и принимает\n\tсоединения через Unix-сокет \"/var/run/postgresql/.s.PGSQL.5432\"?", "stderr_lines": ["psql: не удалось подключиться к серверу: Нет такого файла или каталога", "\tОн действительно работает локально и принимает", "\tсоединения через Unix-сокет \"/var/run/postgresql/.s.PGSQL.5432\"?"], "stdout": "", "stdout_lines": []}
failed: [replica] (item=SELECT schemaname, tablename FROM pg_catalog.pg_tables;) => {"ansible_loop_var": "item", "changed": true, "cmd": "sudo -iu postgres psql -c \"SELECT schemaname, tablename FROM pg_catalog.pg_tables;\"", "delta": "0:00:00.130045", "end": "2021-10-18 01:09:20.522969", "item": "SELECT schemaname, tablename FROM pg_catalog.pg_tables;", "msg": "non-zero return code", "rc": 2, "start": "2021-10-18 01:09:20.392924", "stderr": "psql: не удалось подключиться к серверу: Нет такого файла или каталога\n\tОн действительно работает локально и принимает\n\tсоединения через Unix-сокет \"/var/run/postgresql/.s.PGSQL.5432\"?", "stderr_lines": ["psql: не удалось подключиться к серверу: Нет такого файла или каталога", "\tОн действительно работает локально и принимает", "\tсоединения через Unix-сокет \"/var/run/postgresql/.s.PGSQL.5432\"?"], "stdout": "", "stdout_lines": []}
...
ok: [master -> localhost] => (item={'changed': True, 'end': '2021-10-18 01:09:31.839598', 'stdout': 'CREATE SCHEMA', 'cmd': 'sudo -iu postgres psql -c "DROP SCHEMA IF EXISTS test_schema CASCADE; CREATE SCHEMA test_schema;"', 'rc': 0, 'start': '2021-10-18 01:09:31.714466', 'stderr': 'NOTICE:  schema "test_schema" does not exist, skipping', 'delta': '0:00:00.125132', 'invocation': {'module_args': {'creates': None, 'executable': None, '_uses_shell': True, 'strip_empty_ends': True, '_raw_params': 'sudo -iu postgres psql -c "DROP SCHEMA IF EXISTS test_schema CASCADE; CREATE SCHEMA test_schema;"', 'removes': None, 'argv': None, 'warn': False, 'chdir': None, 'stdin_add_newline': True, 'stdin': None}}, 'stdout_lines': ['CREATE SCHEMA'], 'stderr_lines': ['NOTICE:  schema "test_schema" does not exist, skipping'], 'failed': False, 'item': 'DROP SCHEMA IF EXISTS test_schema CASCADE; CREATE SCHEMA test_schema;', 'ansible_loop_var': 'item'})
ok: [master -> localhost] => (item={'changed': True, 'end': '2021-10-18 01:09:32.513114', 'stdout': 'CREATE TABLE', 'cmd': 'sudo -iu postgres psql -c "CREATE TABLE test_schema.test_table(id serial primary key, value varchar(50));"', 'rc': 0, 'start': '2021-10-18 01:09:32.383764', 'stderr': '', 'delta': '0:00:00.129350', 'invocation': {'module_args': {'creates': None, 'executable': None, '_uses_shell': True, 'strip_empty_ends': True, '_raw_params': 'sudo -iu postgres psql -c "CREATE TABLE test_schema.test_table(id serial primary key, value varchar(50));"', 'removes': None, 'argv': None, 'warn': False, 'chdir': None, 'stdin_add_newline': True, 'stdin': None}}, 'stdout_lines': ['CREATE TABLE'], 'stderr_lines': [], 'failed': False, 'item': 'CREATE TABLE test_schema.test_table(id serial primary key, value varchar(50));', 'ansible_loop_var': 'item'})
ok: [master -> localhost] => (item={'changed': True, 'end': '2021-10-18 01:09:33.187441', 'stdout': 'INSERT 0 2', 'cmd': 'sudo -iu postgres psql -c "INSERT INTO test_schema.test_table VALUES (1,\'first\'),(2,\'second\');"', 'rc': 0, 'start': '2021-10-18 01:09:33.068708', 'stderr': '', 'delta': '0:00:00.118733', 'invocation': {'module_args': {'creates': None, 'executable': None, '_uses_shell': True, 'strip_empty_ends': True, '_raw_params': 'sudo -iu postgres psql -c "INSERT INTO test_schema.test_table VALUES (1,\'first\'),(2,\'second\');"', 'removes': None, 'argv': None, 'warn': False, 'chdir': None, 'stdin_add_newline': True, 'stdin': None}}, 'stdout_lines': ['INSERT 0 2'], 'stderr_lines': [], 'failed': False, 'item': "INSERT INTO test_schema.test_table VALUES (1,'first'),(2,'second');", 'ansible_loop_var': 'item'})
...
failed: [replica] (item=SELECT datname AS database_name FROM pg_database;) => {"ansible_loop_var": "item", "changed": true, "cmd": "sudo -iu postgres psql -c \"SELECT datname AS database_name FROM pg_database;\"", "delta": "0:00:00.114135", "end": "2021-10-18 01:09:38.411813", "item": "SELECT datname AS database_name FROM pg_database;", "msg": "non-zero return code", "rc": 2, "start": "2021-10-18 01:09:38.297678", "stderr": "psql: не удалось подключиться к серверу: Нет такого файла или каталога\n\tОн действительно работает локально и принимает\n\tсоединения через Unix-сокет \"/var/run/postgresql/.s.PGSQL.5432\"?", "stderr_lines": ["psql: не удалось подключиться к серверу: Нет такого файла или каталога", "\tОн действительно работает локально и принимает", "\tсоединения через Unix-сокет \"/var/run/postgresql/.s.PGSQL.5432\"?"], "stdout": "", "stdout_lines": []}
failed: [replica] (item=SELECT schema_name FROM information_schema.schemata;) => {"ansible_loop_var": "item", "changed": true, "cmd": "sudo -iu postgres psql -c \"SELECT schema_name FROM information_schema.schemata;\"", "delta": "0:00:00.112270", "end": "2021-10-18 01:09:39.068438", "item": "SELECT schema_name FROM information_schema.schemata;", "msg": "non-zero return code", "rc": 2, "start": "2021-10-18 01:09:38.956168", "stderr": "psql: не удалось подключиться к серверу: Нет такого файла или каталога\n\tОн действительно работает локально и принимает\n\tсоединения через Unix-сокет \"/var/run/postgresql/.s.PGSQL.5432\"?", "stderr_lines": ["psql: не удалось подключиться к серверу: Нет такого файла или каталога", "\tОн действительно работает локально и принимает", "\tсоединения через Unix-сокет \"/var/run/postgresql/.s.PGSQL.5432\"?"], "stdout": "", "stdout_lines": []}
failed: [replica] (item=SELECT schemaname, tablename FROM pg_catalog.pg_tables;) => {"ansible_loop_var": "item", "changed": true, "cmd": "sudo -iu postgres psql -c \"SELECT schemaname, tablename FROM pg_catalog.pg_tables;\"", "delta": "0:00:00.109090", "end": "2021-10-18 01:09:39.728490", "item": "SELECT schemaname, tablename FROM pg_catalog.pg_tables;", "msg": "non-zero return code", "rc": 2, "start": "2021-10-18 01:09:39.619400", "stderr": "psql: не удалось подключиться к серверу: Нет такого файла или каталога\n\tОн действительно работает локально и принимает\n\tсоединения через Unix-сокет \"/var/run/postgresql/.s.PGSQL.5432\"?", "stderr_lines": ["psql: не удалось подключиться к серверу: Нет такого файла или каталога", "\tОн действительно работает локально и принимает", "\tсоединения через Unix-сокет \"/var/run/postgresql/.s.PGSQL.5432\"?"], "stdout": "", "stdout_lines": []}
failed: [replica] (item=SELECT * FROM test_schema.test_table;) => {"ansible_loop_var": "item", "changed": true, "cmd": "sudo -iu postgres psql -c \"SELECT * FROM test_schema.test_table;\"", "delta": "0:00:00.112450", "end": "2021-10-18 01:09:40.404463", "item": "SELECT * FROM test_schema.test_table;", "msg": "non-zero return code", "rc": 2, "start": "2021-10-18 01:09:40.292013", "stderr": "psql: не удалось подключиться к серверу: Нет такого файла или каталога\n\tОн действительно работает локально и принимает\n\tсоединения через Unix-сокет \"/var/run/postgresql/.s.PGSQL.5432\"?", "stderr_lines": ["psql: не удалось подключиться к серверу: Нет такого файла или каталога", "\tОн действительно работает локально и принимает", "\tсоединения через Unix-сокет \"/var/run/postgresql/.s.PGSQL.5432\"?"], "stdout": "", "stdout_lines": []}
