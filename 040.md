...
[details --no-link]:[PSQL: streaming_barman IDENTIFY SYSTEM](./040/files/master-local_access_check-psql--U-streaming_barman--h-127.0.0.1--c-IDENTIFY_SYSTEM-replication=1.yml.txt)
