...
ok: [master] => {
    "msg": "MySQL root password is 'K.4F_GD2neMJ'"
}
...
ok: [replica] => {
    "msg": "MySQL root password is 'h4r=r-C?)VFy'"
}
...
PLAY RECAP *********************************************************************
replica                    : ok=9    changed=5    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0   
