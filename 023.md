...
[пример аудита №1](./023/ansible/roles/client/templates/audit.just_for_example/file_change_audit.service)

<details><summary>см. пример аудита №1</summary>
...
[скрипт проверки](./023/ansible/roles/client/templates/audit.just_for_example/file_change_audit.sh)

<details><summary>см. скрипт проверки</summary>
...
[path_contents_change_audit.sh](./023/ansible/roles/client/templates/audit/etc_rsyslog.d/path_contents_change_audit_log.conf)

<details><summary>см. path_contents_change_audit.sh</summary>
...
[path_contents_change_audit.env](./023/ansible/roles/client/templates/audit/systemd/nginx-conf-path-contents-change-audit-timed.env)

<details><summary>см. path_contents_change_audit.env</summary>

```properties
AUDIT_PATH=/etc/nginx
...
[nginx_conf_path_contents_change_audit.service](./023/ansible/roles/client/templates/audit/systemd/nginx-conf-path-contents-change-audit-timed.service)

<details><summary>см. nginx_conf_path_contents_change_audit.service</summary>
...
[nginx_conf_path_contents_change_audit.timer](./023/ansible/roles/client/templates/audit/systemd/nginx-conf-path-contents-change-audit-timed.timer)

<details><summary>см. nginx_conf_path_contents_change_audit.timer</summary>
...
__Решение:__
- [Vagrantfile "чистых" виртуалок](./023/vm/Vagrantfile)

<details><summary>см. Vagrantfile "чистых" виртуалок</summary>
...
[Отправка на центральный сервер](./023/ansible/roles/client/templates/audit/etc_rsyslog.d/path_contents_change_audit_log.conf)

<details><summary>см. Отправка на центральный сервер</summary>
...
При настройке Rsyslog необходимо не допускать дублирования в правил из `/etc/rsyslog.conf` и `/etc/rsyslog.conf`, иначе это приведет к дублированию отправки\регистрации записи лога. Частично решается использованием `& ~`.